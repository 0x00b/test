...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestProto.ProtobufAny();
  });
  ...
  describe('ProtobufAny', function() {
    it('should create an instance of ProtobufAny', function() {
      ...
      //var instane = new TestProto.ProtobufAny();
      //expect(instance).to.be.a(TestProto.ProtobufAny);
    });
    ...
    it('should have the property typeUrl (base name: "typeUrl")', function() {
      ...
      //var instance = new TestProto.ProtobufAny();
